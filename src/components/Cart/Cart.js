                ...
                <div class="col-lg-12 col-xs-12 d-flex justify-content-center">
                    <Table striped bordered hover>
                        ...
                        <tbody>
                            {cartList.map(prod=>                
                                <tr>
                                    <td className="td-cart"><FontAwesomeIcon icon={faTrash} className="empty-icon"/></td>
                                    ...
                                    <td className="td-cant"><div className="td-container"><div className="cant-container">{prod.quantity}</div><div className="arrow-container"><FontAwesomeIcon icon={faAngleUp} className="up"/><FontAwesomeIcon icon={faAngleDown} className="down"/></div></div></td>
